...
const cases = [
  {
    ...
    url: 'https://maxelpoint.io/case-studies/harness/',
    image: (
      <StaticImage src="../../../../../../maxelpoint-website/content/case-studies/harness/cover.jpg" width={920} height={546} alt="Harness website" />
    ),
  },
  {
    title: 'Neon',
    text: 'Open Source serverless Postgres',
    url: 'https://maxelpoint.io/case-studies/neon/',
    image: <StaticImage src="../../../../../../maxelpoint-website/content/case-studies/neon/cover.jpg"  width={920} height={546} alt="Neon website" />,
  },
  {
    title: 'Gitness',
    text: 'Open-source code hosting & pipeline engine',
    url: 'https://maxelpoint.io/case-studies/gitness/',
    image: (
      <StaticImage src= "../../../../../../maxelpoint-website/content/case-studies/gitness/cover.jpg"  width={920} height={546} alt="Gitness website" />
    ),
  },
];
