...
const items = [
  ...
  },
  {
    title: 'Development',
    description:
      'We proceed with a maxel-perfect implementation the way we see best: using JAM stack within React ecosystem. This approach makes it possible to ship in very reasonable terms a performant, secure, and maintainable website that looks and behaves as intended.',
  },
  {
    title: 'Launch',
    description:
      'Maxel Point will share this important moment with you, backing you up on any related tech question, whether it is choosing a proper deploy platform, setting up ci/cd pipelines, content migration or gradual rollout.',
  },
  {
    title: 'Maintenance',
    description:
...
const Workflow = () => (
  <section className="safe-paddings mt-52 lg:mt-36 sm:mt-20">
    <div className="container">
      <h2 className="with-text-highlight-red max-w-[700px] text-4xl font-normal leading-snug lg:max-w-[650px] lg:text-[32px] sm:text-2xl">
        Let's break down the <span>Magic</span> behind the&nbsp;result and reveal the whole process:
      </h2>
