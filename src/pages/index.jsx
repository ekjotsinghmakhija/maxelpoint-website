...
const advantages = {
  title: 'It doesn’t have to be like that. Work&nbsp;with&nbsp;Maxel Point to see the difference:',
  items: [
    {
    ...
    },
    {
      ...
      description:
        'Communication is the key to any successful relationship. At Maxel Point we answer in a matter of hours, eagerly joining requirements discussions and deliver constant updates, making our work as transparent as it possible.',
    },
    {
